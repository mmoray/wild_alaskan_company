...
class PostsController extends Controller
{
    ...
    public function show(Request $request, int $posts_pk)
    {
    ...
    {
        return "Handling the {$request->method()} HTTP Request - Store PostsController Method with the posts_pk parameter set to {$posts_pk}"; 
    }
